addLayer("p", { //这是代码中的节点代码 例如player.p可以调用该层级的数据 尽量使用顺手的字母什么的 不建议数字开头
 ...
 if (hasMilestone("ng", 1)) g = slgadd(slgpow(player.points,0.5),-0.38)
 if (hasMilestone("ng", 1)) g = g.mul(player.pz.points.add(1))
...
//软上限
        if (g.gte(1e100) && !(hasMilestone("am", 14)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e90)
        if (g.gte(1e125) && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e114)
        if (g.gte(1e185) && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(3e171)
        if (g.gte(1e225) && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e210)
        if (g.gte(1e256) && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e240)
        if (g.gte(1e289) && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e272)
        if (g.gte("1e324") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul(1e306)
        if (g.gte("1e361") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e342")
        if (g.gte("1e400") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e380")
        if (g.gte("1e441") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e420")
        if (g.gte("1e484") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e462")
        if (g.gte("1e529") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e506")
        if (g.gte("1e625") && !(hasMilestone("am", 26)||hasMilestone("ng", 1))) g = expRoot(g, 2).mul("1e600")
...
if (hasMilestone("am", 30)) g =g.pow(player.points.add(10).slog())
        if (inChallenge("pz", 21)) g = expPow(g, 0.5)
        if (inChallenge("pz", 22)) g = expPow(g, 0.5)
 if (hasMilestone("ng", 1)) g = g.log10().add(1).log10().add(1).pow(0.76)
